...
- @docs/2-prd.md, @docs/7-execution-plan.md, @docs/9-style-guide.md, @swagger/swagger.json, @docs/8-wireframes.md 핵심문서를 분석한다.
...
- 테스트 완료되면 @docs/7-execution-plan.md 문서의 ${TASK_NUMBER} 완료조건을 체크한다.